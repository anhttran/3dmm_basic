...
void BaselFaceEstimator::getTextureEdgeIndices(std::vector<int> &out){
	out.clear();
	for (int i=0;i<BaselFace::BaselFace_texEdges_h*BaselFace::BaselFace_texEdges_w;i++)
		out.push_back(BaselFace::BaselFace_texEdges[i] - 1);
}


cv::Mat BaselFaceEstimator::getShapePartsFlipExpr(cv::Mat weight, cv::Mat exprWeight){
	Mat shapeMU(BaselFace::BaselFace_shapeMU_h,1,CV_32F,BaselFace::BaselFace_shapeMU);
	Mat shapePC(BaselFace::BaselFace_shapePC_h,BaselFace::BaselFace_shapePC_w,CV_32F,BaselFace::BaselFace_shapePC);
	Mat shapeEV(BaselFace::BaselFace_shapeEV_h,1,CV_32F,BaselFace::BaselFace_shapeEV);
	Mat exprMU(BaselFace::BaselFace_expMU_h,1,CV_32F,BaselFace::BaselFace_expMU);
	Mat exprPC(BaselFace::BaselFace_expPCFlip_h,BaselFace::BaselFace_expPCFlip_w,CV_32F,BaselFace::BaselFace_expPCFlip);
	Mat exprEV(BaselFace::BaselFace_expEV_h,1,CV_32F,BaselFace::BaselFace_expEV);
	return coef2objectParts(weight,shapeMU,shapePC,shapeEV) + coef2object(exprWeight,exprMU,exprPC,exprEV);
}
cv::Mat BaselFaceEstimator::getShapeFlipExpr(cv::Mat weight, cv::Mat exprWeight){
	Mat shapeMU(BaselFace::BaselFace_shapeMU_h,1,CV_32F,BaselFace::BaselFace_shapeMU);
	Mat shapePC(BaselFace::BaselFace_shapePC_h,BaselFace::BaselFace_shapePC_w,CV_32F,BaselFace::BaselFace_shapePC);
	Mat shapeEV(BaselFace::BaselFace_shapeEV_h,1,CV_32F,BaselFace::BaselFace_shapeEV);
	Mat exprMU(BaselFace::BaselFace_expMU_h,1,CV_32F,BaselFace::BaselFace_expMU);
...
cv::Mat BaselFaceEstimator::getLMByAlphaFlipExpr(cv::Mat alpha, float yaw, std::vector<int> inds, cv::Mat exprWeight){
	cv::Mat alpha2 = alpha.clone();
	cv::Mat exp2 = exprWeight.clone();
	for (int i=0;i<alpha.rows;i++) alpha2.at<float>(i,0) *= BaselFace::BaselFace_shapeEV[i];
	for (int i=0;i<exp2.rows;i++) exp2.at<float>(i,0) *= BaselFace::BaselFace_expEV[i];
	int N = inds.size();
	int BPC = BaselFace::BaselFace_shapePC_w;
	int EPC = BaselFace::BaselFace_expPCFlip_w;
	Mat tmpShape(N,3,CV_32F);
	float val;
	for (int i=0;i<inds.size();i++){
		int ind;
		...
		for (int j=0;j<3;j++) {
			...
			for (k = 0;k<=exp2.rows-5;k+=5) {
				val += exp2.at<float>(k,0) * BaselFace::BaselFace_expPCFlip[(3*ind+j)*EPC + k] + exp2.at<float>(k+1,0) * BaselFace::BaselFace_expPCFlip[(3*ind+j)*EPC + k+1]
					+ exp2.at<float>(k+2,0) * BaselFace::BaselFace_expPCFlip[(3*ind+j)*EPC + k+2]
					+ exp2.at<float>(k+3,0) * BaselFace::BaselFace_expPCFlip[(3*ind+j)*EPC + k+3]
					+ exp2.at<float>(k+4,0) * BaselFace::BaselFace_expPCFlip[(3*ind+j)*EPC + k+4];
			}
			for (;k<exp2.rows;k++) {
				val += exp2.at<float>(k,0) * BaselFace::BaselFace_expPCFlip[(3*ind+j)*EPC + k];
			}
			tmpShape.at<float>(i,j) = val;
		}
	}
...
cv::Mat BaselFaceEstimator::getLMByAlphaPartsFlipExpr(cv::Mat alpha, float yaw, std::vector<int> inds, cv::Mat exprWeight){
	int N = inds.size();
	int numparts = 4;
	int M = alpha.rows/numparts;
	cv::Mat alpha2 = alpha.clone();
...
cv::Mat BaselFaceEstimator::getTriByAlphaFlipExpr(cv::Mat alpha, std::vector<int> inds, cv::Mat exprWeight){
	cv::Mat alpha2 = alpha.clone();
	for (int i=0;i<alpha.rows;i++) alpha2.at<float>(i,0) *= BaselFace::BaselFace_shapeEV[i];
	cv::Mat exp2 = exprWeight.clone();
	for (int i=0;i<exp2.rows;i++) exp2.at<float>(i,0) *= BaselFace::BaselFace_expEV[i];
...
cv::Mat BaselFaceEstimator::getTriByAlphaPartsFlipExpr(cv::Mat alpha, std::vector<int> inds, cv::Mat exprWeight){
	int N = inds.size();
	int numparts = 4;
	int M = alpha.rows/numparts;
	cv::Mat alpha2 = alpha.clone();
